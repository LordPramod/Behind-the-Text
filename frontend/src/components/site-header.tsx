...
import { CodeXml, Feather, MenuIcon, Newspaper } from "lucide-react";
  ...
  return (
    <header className="py-4 border-b max-md:backdrop-blur-sm md:border-none sticky top-0 z-10">
      <div className="container max-md:px-4">
        <div className="flex items-center justify-between md:border md:p-2.5 md:rounded-xl max-w-2xl mx-auto md:backdrop-blur-sm ">
          <Link href="/">
            ...
            <Drawer open={isOpen} onOpenChange={setIsOpen}>
              ...
              <DrawerContent className="p-8">
                <div className="inline-flex items-center center gap-3 mt-8">
                  ...
                  <p className="font-bold">Behind The Text</p>
                </div>
